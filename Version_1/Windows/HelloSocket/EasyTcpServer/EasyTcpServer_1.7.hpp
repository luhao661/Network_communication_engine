...
#include "MessageHeader_1.2.hpp"//改为100字节的数据包
...
public:
	...
	virtual void OnNetMsg(SOCKET client_sock, DataHead* pHead)=0;
};
...
public:
	...
	void StartThread()
	{
		for (int n = 0; n < CELLSERVER_THREADS_COUNT; ++n)
		{
	...
	virtual void OnNetMsg(SOCKET client_sock, DataHead* pHead);
